...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 * document creator
	 */
	define ('PDF_CREATOR', 'Sciences Po');

	/**
	 * document author
	 */
	define ('PDF_AUTHOR', 'Sciences Po');

	/**
	 * header title
	 */
	define ('PDF_HEADER_TITLE', 'Billet Sciences Po');

	/**
	 * header description string
	 */
	define ('PDF_HEADER_STRING', "by Sciences Po - www.sciences-po.fr");
